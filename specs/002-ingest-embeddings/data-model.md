...
A `ContentChunk` represents a piece of text extracted from the source book, ready to be vectorized and stored.

### Attributes

| Attribute | Type | Description | Required |
|---|---|---|---|
| `content` | String | The actual text content of the chunk (500-1000 tokens). | Yes |
