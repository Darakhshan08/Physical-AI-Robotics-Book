...
**Structure Decision**: Per the user's request, the implementation will be consolidated into a single `main.py` file within an `app` directory. This simplifies the initial implementation, focusing on core functionality rather than a complex application structure.
